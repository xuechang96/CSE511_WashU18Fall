...
class ParticleFilter(InferenceModule):
  ...
  def initializeUniformly(self, gameState):
    ...
    for i in range(self.numParticles):
      particlePos=random.choice(self.legalPositions)
  ...
  def observe(self, observation, gameState):
    ...
    if noisyDistance==None:
      ...
      for pos in self.legalPositions:
        ...
        if emissionModel[trueDistance] > 0:
          allPossible[pos] += emissionModel[trueDistance] * beliefs[pos]
  ...
  def initializeParticles(self):
    ...
    for i in range(self.numParticles):
      ...
      for j in range(self.numGhosts):
        eachParticle.append(random.choice(self.legalPositions))
      self.particles.append(tuple(eachParticle))
